  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Vos informations de profil pour les candidatures.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={(e) =>
              onUpdateLanguages(e.target.value.split(",").map((s) => s.trim()))
            }
            rows={2}
          />
        </div>
              ...
              >
                <div className="flex-1 grid grid-cols-2 gap-3">
                  <Field
                    ...
                    onChange={(v) => onUpdateSkill(i, "category", v)}
                  />
                  <Field
                    label="Technologies"
                    value={skill.technologies}
                    onChange={(v) => onUpdateSkill(i, "technologies", v)}
                  />
                </div>
                <Button
                  variant="ghost"
